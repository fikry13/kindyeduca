                    ...
                    <table class="table" id="sessions-list-table">
                        ...
                        @foreach($sessions as $session)
                            <tr>
                                <td>
                                    @php
                                        if($session->student->grade != null)
                                            $grade =  "<span class=\"label label-default\" style=\"background-color:". $session->student->grade->school->color. "; color: #fff;\">". $session->student->grade->school->name . " " . $session->student->grade->grade . "</span>"
                                    @endphp
                                ...
                                @endif
                                <td>
                                    <a href="{{ route('backpack.page.session', ['id' => $session->id]) }}">

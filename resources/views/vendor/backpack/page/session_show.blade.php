                        ...
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <a href="{{ route('backpack.page.session_status', ['id' => $session->id, 'status' => 3]) }}"><button type="button" class="btn btn-success">Terima</button></a>
                                </div>
                            </div>
                            <!-- /.modal-content -->
                        </div>
                    ...
                    <div class="modal fade" id="modal-reject" style="display: none;">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <a href="{{ route('backpack.page.session_status', ['id' => $session->id, 'status' => 2]) }}"><button type="button" class="btn btn-danger">Tolak</button></a>
                                </div>
                            </div>
                            <!-- /.modal-content -->
                        </div>
            ...
            <div class="box">
                <div class="box-body box-profile">
                    <img class="profile-user-img img-responsive img-circle" style="width: 250px;"
                         src="{{ backpack_avatar_url($student) }}">
                    ...
                    <p class="text-muted">
                        {!! $student->description==null ? '<span style="color: #ccc">Description is Empty</span>' : $student->description !!}
                    </p>
                    <hr>
                    ...
                    <p class="text-muted">
                        {!! $student->gender? "<i class='fa fa-fw fa-mars'></i> Laki-laki" : "<i class='fa fa-fw fa-venus'></i> Perempuan" !!}
                    </p>
                    <hr>
                    @if($student->hasRole('student'))
                        ...
                        @if($student->grade != null)
                            <p class="text-muted">
                                <span class="label label-default" style="background-color: {{ $student->grade->school->color }}; color: #fff;">{{ $student->grade->school->name . " " . $student->grade->grade }}</span>
                            </p>
                        @endif
                        <hr>
                    @endif

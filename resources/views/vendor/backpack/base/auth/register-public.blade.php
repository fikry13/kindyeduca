...
@section('content')
    <div class="row m-t-40">
        <div class="col-md-4 col-md-offset-4">
            <h3 class="text-center m-b-20">Daftar Guru atau Murid</h3>
            <div class="box">
                <div class="box-body">
                    <form class="col-md-12 p-t-10" role="form" method="POST" action="{{ route('backpack.auth.register_public') }}">
                        {!! csrf_field() !!}
                        ...
                        <div class="form-group">
                            <div>
                                <button type="submit" class="btn btn-block btn-primary" name="register" value="teacher">
                                    Daftar Tentor
                                </button>
                            </div>
                        </div>
                        <div class="form-group">
                            <div>
                                <button type="submit" class="btn btn-block btn-danger" name="register" value="student">
                                    Daftar Murid
                                </button>
                            </div>
                        </div>

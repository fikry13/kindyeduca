...
@section('content')
    <div class="row m-t-40">
        <div class="col-md-4 col-md-offset-4">
            <h3 class="text-center m-b-20">{{ trans('backpack::base.login') }} Kindy Educa</h3>
            <div class="box">
                <div class="box-body">
            ...
            @if (backpack_users_have_email())
                <div class="text-center m-t-10"><a href="{{ route('backpack.auth.password.reset') }}">Lupa Password</a></div>
            @endif
            @if (config('backpack.base.registration_open'))
                <div class="text-center m-t-10"><a href="{{ route('backpack.auth.register') }}">{{ trans('backpack::base.register') }}</a></div>
            @endif
            <div class="text-center m-t-10"><a href="{{ route('backpack.auth.register_public') }}">Daftar</a></div>
        </div>
    </div>
@endsection
